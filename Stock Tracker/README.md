...
Use your real GitHub username in place of `YOUR_USERNAME`. If the repo already has an `origin` you want to change:

```bash
git remote set-url origin https://github.com/YOUR_USERNAME/stock-tracker.git
git push -u origin main
```
